...
def get(event_id: int, filter: Optional[Dict] = None, include: Optional[str] = None, page: Optional[Dict] = None) -> List[Dict]:
    ...
    Args:
        ...
        filter (Optional[Dict]): A dictionary containing filter criteria for bids. Each key represents a filter field with its corresponding value. Supported filters:
            ...
            Defaults to None.
        include (Optional[str]): A string specifying additional related resources to include in the response. Supported values:
