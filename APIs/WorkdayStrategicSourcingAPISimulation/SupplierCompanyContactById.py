...
def get(company_id: int, contact_id: int, include: Optional[str] = None) -> Tuple[Union[Dict[str, Any], Dict[str, str]], int]:
    """
...
def patch(company_id: int, contact_id: int, include: Optional[str] = None, 
    ...
    Args:
        ...
        include (Optional[str], default=None): Comma-separated list of related resources to include
            in the response. Not fully implemented in simulation.
        body (Optional[Dict[str, Any]], default=None): Dictionary containing the fields to update.
            Required fields:
