...
def list_awards() -> List[Dict]:
    """Retrieves a list of all contract awards in the system.

    This function returns a comprehensive list of all contract awards currently
    defined in the system, including their properties and configurations. The
    awards include detailed information about contracts, suppliers, and associated
    metrics.
    ...
    Note:
        The returned list includes all awards regardless of their status or
        configuration. Each award dictionary contains all fields as defined
        in the system. The returned data is read-only and should not be modified
        directly.
    """
