...
def get(external_id: str, include: Optional[str] = None, 
    ...
    This function first locates the supplier company using its external ID, then returns
    all contacts associated with that company, with optional filtering and related
    resource inclusion.
